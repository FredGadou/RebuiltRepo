...
let gestionLinkDiv =document.getElementById('gestionLinkDiv');
...
let devPage = document.getElementById('devPage');
...
gestionLinkDiv.addEventListener('mousedown', () => {
	openDevPage();
});
...
function openDevPage() {
	...
	if (isToRegister) {
        actionRegister.push(['openDevPage']);
    }
...
function actionBack() {
    ...
    if (actionRegister.length > 1) {
        ...
        } else if (lastAction === 'openDevPage' || fctn === 'openDevPage') {
