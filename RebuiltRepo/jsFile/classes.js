...
class Company {
    constructor(company, list) {
        ...
        this.list = list;
        this.img = `/Volumes/GoogleDrive/My Drive/RebuiltRepo/image/${company}.jpg`;
    }
}
...
class Type {
    constructor(type, list) {
        this.type = type;
        this.list = list;
        this.img = `/Volumes/GoogleDrive/My Drive/RebuiltRepo/image/${type}.jpg`;
    }
}
...
class Rebuilt {
    ...
    addPart(part) {
        part.addRebuiltAssociated(this);
    ...
    search(keyWord) {
        ...
        if (this.description.toLowerCase().includes(keyWord)) contain = true;
        ...
        this.machineList.forEach(machine => {
            let machineId = machine.id.toLowerCase();
...
class Part {
    constructor(id, name) {
        ...
        this.description = '';
        this.sectionMaga = '';
        this.rebuiltAssociated = new Map();
        this.company = '';
    }
    addRebuiltAssociated(rebuilt) {
        this.rebuiltAssociated.set(rebuilt.cascadesId, rebuilt);
    }
    getRebuiltAssociated() {
        return this.rebuiltAssociated;
    }
    search(keyWord) {
        keyWord = keyWord.toLowerCase();
        let contain = false;
        ...
        if (this.company.toLowerCase().includes(keyWord)) {
            contain = true;
        }
        return contain;
    }
